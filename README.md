...
1. Adding elements,   2. Adding element at specific index, 3. Adding multiple elements, 4. Accessing elements,5. Updating elements, 6. Removing elements,  7. Searching elements,  8. List size, 9. Iterating over list, 10. Using Iterator,  11. Sorting, 12. Sublist, 13. Clearing the list
   🔗 [Output Screenshot](https://dummy-link.com/1a.png)
...
🔗 [Output Screenshot](https://dummy-link.com/3b1.png)
...
🔗 [Output Screenshot](https://dummy-link.com/3b4.png)
...
🔗 [Output Screenshot](https://dummy-link.com/5a.png)
...
🔗 [Output Screenshot](https://dummy-link.com/5b.png)
...
🔗 [Output Screenshot](https://dummy-link.com/5c.png)
